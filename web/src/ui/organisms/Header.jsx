      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <IconButton icon={<MenuIcon />} handleAction={toggleMenu} />
            </Grid>
          </Grid>
          ...
          >
            <DrawerList
              items={
                data
                  ? [
                      <DrawerItem text="Recipes" link="/recipes" />,
                      <DrawerItem
                        text="Search By Ingredients"
                        link="/searchByIngredients"
                      />,
                      <DrawerItem text="Add recipe" link="/addrecipe" />,
                      <DrawerItem
                        text={`${data.name}`}
                  ...
                  : [
                      ...
                      <DrawerItem
                        ...
                        link="/searchByIngredients"
                      />,
                      <DrawerItem text="Log in" link="/login" />,
                      <DrawerItem text="Sign up" link="/signup" />,
                    ]
              }
            />
          </Drawer>
